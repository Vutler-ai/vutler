...
const PLANS = {
  free: {
    ...
    products: [],
    features: [],
    limits: { agents: 1, tokens_month: 50000, storage_gb: 1, social_posts_month: 0, nexus_enterprise_seats: 0 },
    snipara: ['context'],
  ...
  office_starter: {
    ...
    limits: { agents: 0, tokens_month: 100000, storage_gb: 10, social_posts_month: 0, nexus_enterprise_seats: 0 },
    snipara: ['context'],
  ...
  office_team: {
    ...
    products: ['office'],
    features: ['chat', 'drive', 'email', 'tasks', 'calendar', 'integrations', 'dashboard', 'goals', 'crm', 'pixel-office'],
    limits: { agents: 0, tokens_month: 500000, storage_gb: 100, social_posts_month: 0, nexus_enterprise_seats: 0 },
    snipara: ['context'],
  ...
  agents_starter: {
    ...
    limits: { agents: 25, tokens_month: 250000, storage_gb: 10, social_posts_month: 10, nexus_nodes: 2, nexus_local: 2, nexus_enterprise: 0, nexus_enterprise_seats: 0 },
  ...
  agents_pro: {
    ...
    products: ['agents'],
    features: ['agents', 'nexus', 'marketplace', 'sandbox', 'builder', 'swarm', 'automations', 'llm-settings', 'tools', 'runtime', 'deployments', 'templates', 'knowledge', 'providers', 'dashboard'],
    limits: { agents: 100, tokens_month: 1000000, storage_gb: 100, social_posts_month: 50, nexus_nodes: 10, nexus_local: 10, nexus_enterprise: 0, nexus_enterprise_seats: 0 },
    snipara: ['context', 'memory'],
    price: { monthly: 7900, yearly: 79000 },
  },
  full: {
    ...
    features: ['*'],
    limits: { agents: 100, tokens_month: 1000000, storage_gb: 100, social_posts_month: 100, nexus_nodes: 10, nexus_local: 10, nexus_enterprise: 0, nexus_enterprise_seats: 0 },
    snipara: ['context', 'memory'],
