...
const PLANS = {
  free: {
    ...
    limits: { agents: 1, tokens_month: 50000, storage_gb: 0.5, social_posts_month: 0, nexus_enterprise_seats: 0 },
    snipara: ['context'],
  ...
  office_starter: {
    ...
    limits: { agents: 2, tokens_month: 100000, storage_gb: 5, social_posts_month: 0, nexus_enterprise_seats: 0 },
  ...
  office_team: {
    ...
    limits: { agents: 10, tokens_month: 500000, storage_gb: 50, social_posts_month: 0, nexus_enterprise_seats: 0 },
    snipara: ['context', 'memory'],
  ...
  agents_starter: {
    ...
    tier: 'agents',
    products: ['agents'],
    features: ['agents', 'memory', 'nexus', 'marketplace', 'sandbox', 'builder', 'swarm', 'automations', 'llm-settings', 'tools', 'runtime', 'deployments', 'templates', 'knowledge', 'providers', 'dashboard'],
    limits: { agents: 10, tokens_month: 250000, storage_gb: 5, social_posts_month: 10, nexus_nodes: 2, nexus_local: 2, nexus_enterprise: 0, nexus_enterprise_seats: 0 },
    snipara: ['context', 'memory'],
    price: { monthly: 2900, yearly: 29000 },
  },
  agents_pro: {
    ...
    products: ['agents'],
    features: ['agents', 'memory', 'nexus', 'marketplace', 'sandbox', 'builder', 'swarm', 'automations', 'llm-settings', 'tools', 'runtime', 'deployments', 'templates', 'knowledge', 'providers', 'dashboard'],
    limits: { agents: 50, tokens_month: 1000000, storage_gb: 25, social_posts_month: 50, nexus_nodes: 10, nexus_local: 10, nexus_enterprise: 0, nexus_enterprise_seats: 0 },
    snipara: ['context', 'memory'],
    price: { monthly: 7900, yearly: 79000 },
  },
  full: {
    ...
    features: ['*'],
    limits: { agents: 50, tokens_month: 1000000, storage_gb: 100, social_posts_month: 100, nexus_nodes: 10, nexus_local: 10, nexus_enterprise: 0, nexus_enterprise_seats: 0 },
    snipara: ['context', 'memory'],
  ...
  nexus_enterprise: {
    ...
    products: ['agents'],
    features: ['agents', 'memory', 'nexus', 'marketplace', 'sandbox', 'builder', 'swarm', 'automations', 'llm-settings', 'tools', 'runtime', 'deployments', 'templates', 'knowledge', 'providers', 'dashboard'],
    limits: { agents: 100, tokens_month: 1000000, storage_gb: 100, social_posts_month: 100, nexus_nodes: 1, nexus_local: 0, nexus_enterprise: 1, nexus_enterprise_seats: 5 },
    snipara: ['context', 'memory'],
  ...
  enterprise: {
    ...
    products: ['office', 'agents'],
    features: ['*'],
    limits: { agents: -1, tokens_month: -1, storage_gb: -1, social_posts_month: 500, nexus_nodes: -1, nexus_local: -1, nexus_enterprise: -1, nexus_enterprise_seats: -1 },
    snipara: ['context', 'memory'],
  ...
  beta: {
    ...
    products: ['office', 'agents'],
    features: ['*'],
    limits: { agents: 50, tokens_month: 500000, storage_gb: 50, social_posts_month: 100, nexus_nodes: 5, nexus_local: 5, nexus_enterprise: 1, nexus_enterprise_seats: 5 },
    snipara: ['context', 'memory'],
    price: { monthly: 0, yearly: 0 },
  },
};
