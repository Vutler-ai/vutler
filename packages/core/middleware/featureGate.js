...
const PLANS = {
  ...
  agents_starter: {
    ...
    tier: 'agents',
    products: ['agents'],
    features: ['agents', 'nexus', 'marketplace', 'sandbox', 'builder', 'swarm', 'automations', 'llm-settings', 'tools', 'runtime', 'deployments', 'templates', 'knowledge', 'providers', 'dashboard', 'cloud_sandbox', 'mobile_dispatch'],
  ...
  agents_pro: {
    ...
    tier: 'agents',
    products: ['agents'],
    features: ['agents', 'nexus', 'marketplace', 'sandbox', 'builder', 'swarm', 'automations', 'llm-settings', 'tools', 'runtime', 'deployments', 'templates', 'knowledge', 'providers', 'dashboard', 'cloud_sandbox', 'mobile_dispatch', 'enterprise_nexus'],
