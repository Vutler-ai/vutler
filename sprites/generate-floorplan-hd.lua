...
spr.filename = "office-floorplan-hd.png"
...
local MARGIN = 24       -- outer margin
local WALL = 10          -- wall thickness
local HALL_H = 40       -- hallway height
local TOP_H = 380       -- top rooms height
local BOT_H = 380       -- bottom rooms height
local TOP_Y = MARGIN
...
-- Save
spr:saveAs("/Users/lopez/.openclaw/workspace/projects/vutler/sprites/office-floorplan-hd.png")
